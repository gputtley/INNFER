...
python3 /vols/cms/yhe4823/INNFER/scripts/innfer.py --cfg="/vols/cms/yhe4823/INNFER/configs/run/btm_full_270526_sbi.py" --data-vs-simulation --extra-output-dir-name="DataVsSimStatPlusSystWithExtraHypothesis" --include-uncertainty --plot-extra-hypothesis="bw_mass=173.5;bw_mass=171.5" --ratio-range="0.8,1.2" --sim-type="full" --specific-category="2223" --step="DistributionPlot"  --specific="file_name=combined;val_ind=2;category=2223"
